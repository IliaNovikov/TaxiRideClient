...
class SavedCardSelectorAdapter(
    private val context: Context,
    private val cards: List<Card>,
    private val onCardClickListener: OnCardClickListener) : RecyclerView.Adapter<SavedCardSelectorAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onCardClickListener.onClick(card, position)
        }
    }
}